...
public class HttpClientUtil {
	...
	public static String get2(String url,String city){
		...
		try {
			...
			stringBuffer.append(url).append("/").append(city);
			...
			if (200 != statusCode) {
				System.out.println(EntityUtils.toString(execute.getEntity(), "utf-8")+"aaa");
				return "";
	...
	public static String get(String url,HashMap<String, Object> params){
		...
		try {
			...
			StringBuffer stringBuffer = new StringBuffer();
			stringBuffer.append(url).append(System.currentTimeMillis());	
	...
	/*	JSONObject parseObject = JSON.parseObject(string);
		...
		WeatherBean weatherBean = JSON.toJavaObject(today, WeatherBean.class);
		*/
